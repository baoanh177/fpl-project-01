...
var JQVMap = function (a) {
    ...
    if (
        ...
        a.values &&
            ((this.values = a.values), this.setValues(a.values)),
        a.selectedRegions)
    )
    ...
    (JQVMap.prototype.deselect = function (a, b) {
        if (
            ...
            this.selectedRegions.splice(this.selectIndex(a), 1),
                jQuery(this.container).trigger(
                    "regionDeselect.jqvmap",
                    [a]
                ),
        ...
        if (
            ...
            "content" === b
                ? jQuery.each(a, function (a, b) {
                      if (
                          0 !== jQuery("#" + c.getCountryId(a)).length
                      ) {
                          var d = c.getPinId(a),
                              e = jQuery("#" + d)
                          e.length > 0 && e.remove(),
